...
class _MainScreenState extends State<MainScreen> {
  ...
  void saveCurrentIndex() async {
    ...
    // save current index with 'selectedindex' as key
  ...
  void getCurrentIndex() async {
    ...
    if (prefs.containsKey(prefSelectedIndexKey)) {
      // set current page to previously saved page
      setState(() {
  ...
  void _onItemTapped(int index) {
    setState(() {
      // set ui element _selectedindex to index given
      _selectedIndex = index;
    });
    //set sharedpref page to _selectedindex with 'selectedindex' as key
    saveCurrentIndex();
  }
